...
import typing
__all__: list[str] = ['Layer', 'TwoTuple', 'add', 'get_boundary', 'get_goal', 'get_map', 'get_obstacles', 'get_robot', 'get_start', 'graph', 'polygon', 'rvg', 'vertex']
class Layer:
    @typing.overload
...
class graph:
    ...
    def addEdge(self, v1: vertex, v2: vertex) -> None:
        ...
    def addEdges(self, edges: list[tuple[vertex, vertex]]) -> None:
        ...
    def buildEdges(self) -> None:
        ...
    def draw(self, figPath: str, show: bool = False) -> None:
        ...
    def draw3D(self, figPath: str, show: bool = False) -> None:
        ...
    def drawScript(self) -> str:
        ...
    def getEdges(self) -> list[tuple[vertex, vertex]]:
        ...
    ...
    def getVertices(self) -> list[vertex]:
        ...
    def mergeGraph(self, other: graph) -> None:
        ...
    ...
    def setWeight(self, euclideanWeight: typing.SupportsFloat, rotationalWeight: typing.SupportsFloat) -> None:
        ...
    def shortestPath(self, start: vertex, goal: vertex, verbose: bool = False) -> list[vertex]:
        ...
    def size(self) -> int:
        ...
class polygon:
...
class rvg:
    def __init__(self, robot: polygon, border: polygon, obstacles: list[polygon], resolution: typing.SupportsInt, fineApprox: bool, numThreads: typing.SupportsInt, optimal: bool = False, verbose: bool = False) -> None:
        ...
        """
    def addStartAndGoal(self, start: vertex, goal: vertex) -> None:
        ...
